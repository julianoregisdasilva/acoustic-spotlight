...
import { Play, Instagram, Download } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 md:py-20">
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-6">
          {videos.map((v, i) => (
            <FadeIn key={v.src} direction="up" duration={700} delay={i * 120}>
              <VideoCard src={v.src} poster={v.poster} title={v.title} />
            </FadeIn>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 md:py-20">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {fotos.map((src, i) => (
            <FadeIn key={src} direction="up" duration={700} delay={i * 150}>
              <PhotoCard src={src} index={i} onOpen={() => setOpenPhoto(src)} />
            </FadeIn>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 py-20 text-center md:py-24">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-6">
          <FadeIn direction="up" duration={700} delay={250}>
            <a
          ...
          <FadeIn direction="up" duration={700} delay={400}>
            <a
